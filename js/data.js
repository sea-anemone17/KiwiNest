...
export const DIALOGUES = {
  calm: [
    "오늘 배운 것도 조용히 기억해 둘게요.",
    "이해하기 좋은 설명이었어요.",
    "오늘도 한 걸음 자랐어요."
  ],
  playful: [
    "와아~ 이 정도면 꽤 똑똑해졌는데요?",
    "한 번 더 알려 주면 저 완전 천재가 될지도요!",
    "공부 완료! 이제 조금 잘난 척해도 되나요?"
  ],
  study: [
  ...
  recommend: [
    "조금 애매하면 쉬운 예시로 다시 설명해 볼까요?",
    "설명 가능 단계까지 왔어요! 이제 문제로 확인하면 좋아요.",
    "가르칠 수 있다면 강한 거예요. 복습 때 한 번만 더 꺼내 봐요.",
    "헷갈린 점을 적은 건 아주 좋은 신호예요. 그게 다음 복습 포인트예요."
  ]
};
